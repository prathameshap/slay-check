# Slay Check - AI Code Review Tool (Python)

A high-performance, modular AI code review tool designed for GitHub Actions and local development. Built with Python for excellent AI ecosystem support.
...
```python
from slay_check.ai.base import AIProvider
